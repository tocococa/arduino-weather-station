...
const int analogOutRed = 9; // Analog output pin that the RED LED is attached to
const int analogOutGreen = 3; // Analog output pin that the GREEN LED is attached to
const int analogOutBlue = 6; // Analog output pin that the BLUE LED is attached to
